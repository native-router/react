...
const scriptRel = 'modulepreload';const seen = {};const base = '/native-router-react/';const __vitePreload = function preload(baseModule, deps) {
    // @ts-ignore
...
function App() {
  ...
  return /*#__PURE__*/jsxs(RouterComponent, {
    routes: routes
    // baseUrl={"/native-router-react/".slice(0, -1)}
    ,
    baseUrl: "/native-router-react/"?.slice(0, -1),
    errorHandler: e => /*#__PURE__*/jsx(RouterError, {
      error: e
