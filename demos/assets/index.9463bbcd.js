...
function O$1(a, b, c, e, d) {
  ...
  if (Array.isArray(a)) for (var g = 0; g < a.length; g++) {
    ...
    var f = e + N$1(k, g);
    h += O$1(k, b, c, f, d);
  } else if (f = y$1(a), "function" === typeof f) for (a = f.call(a), g = 0; !(k = a.next()).done;) k = k.value, f = e + N$1(k, g++), h += O$1(k, b, c, f, d);else if ("object" === k) throw b = "" + a, Error(z(31, "[object Object]" === b ? "object with keys {" + Object.keys(a).join(", ") + "}" : b));
  return h;
}
function P$1(a, b, c) {
  if (null == a) return a;
...
const scriptRel = 'modulepreload';const seen = {};const base = '/native-router-react/demos/';const __vitePreload = function preload(baseModule, deps) {
    // @ts-ignore
...
function createStateContext(...params) {
  const ValueContext = /*#__PURE__*/react.exports.createContext(undefined);
  const SetterContext = /*#__PURE__*/react.exports.createContext(undefined);
  function Provider({
    children
  }) {
    const [value, setValue] = react.exports.useState(...params);
    return /*#__PURE__*/jsx(SetterContext.Provider, {
      value: setValue,
      children: /*#__PURE__*/jsx(ValueContext.Provider, {
        value: value,
        children: children
      })
    });
...
function useValueContext(Ctx) {
  return react.exports.useContext(Ctx.ValueContext);
}
function useSetterContext(Ctx) {
  return react.exports.useContext(Ctx.SetterContext);
}

const ViewContext = /*#__PURE__*/react.exports.createContext(null);
 ...
 */
function useView() {
  return react.exports.useContext(ViewContext);
}
...
const DataContext = /*#__PURE__*/react.exports.createContext([undefined, {}]);
...
const LoadingContext = createStateContext();
...
function commit(router, resolvePromise, location) {
  ...
  return currentGuard(resolvePromise).then(resolvedView => {
...
function listen(router, onViewChange) {
  ...
  const locationStack = history.location.state?.locationStack || [history.location];
  router.locationStack = locationStack;
  onLoadingChange('pending');
  Promise.all(locationStack.map(l => resolve(router, l))).then(views => {
...
function resolveView(matched, {
  router,
  location
}) {
  return Promise.all(matched.map(({
    params,
    route
  }, index) => {
    const ctx = {
...
function Loading() {
  const router = useRouter();
  const [percent, setPercent] = react.exports.useState(0);
  ...
  return /*#__PURE__*/reactDom.exports.createPortal( /*#__PURE__*/jsx("button", {
    "data-testid": "loading",
    type: "button",
    title: "Click to cancel!",
    onClick: () => cancel(router),
    className: "b1dll0lj",
    children: percent ? /*#__PURE__*/jsx("div", {
      style: {
        width: `${percent}%`
      },
      className: "dvnac7k"
...
function App() {
  ...
  const routes = {
    component: () => __vitePreload(() => import('./index.c6c8d52a.js'),true?["assets/index.c6c8d52a.js","assets/index.ebf4e2dd.css"]:void 0),
    children: [{
      path: '/',
      component: () => __vitePreload(() => import('./index.1679577d.js'),true?["assets/index.1679577d.js","assets/index.04ec1ac7.css"]:void 0)
    }, {
      path: '/users',
      component: () => __vitePreload(() => import('./index.04b5a5f9.js'),true?["assets/index.04b5a5f9.js","assets/index.358e9db0.css"]:void 0),
      data: fetchList
    }, {
      path: '/users/:id',
      component: () => __vitePreload(() => import('./index.30c2029c.js'),true?["assets/index.30c2029c.js","assets/index.d2976a17.css"]:void 0),
      data: ({
        id
      }) => fetchById(+id)
    }, {
      path: '/help',
      component: () => __vitePreload(() => import('./index.1515325d.js'),true?["assets/index.1515325d.js","assets/index.ba0ba40f.css"]:void 0)
    }, {
      path: '/about',
      component: () => __vitePreload(() => import('./index.961aaa6e.js'),true?["assets/index.961aaa6e.js","assets/index.c2fbffe4.css"]:void 0)
    }]
  };
  if (mode === 'hash') {
    return /*#__PURE__*/jsxs(HashRouter, {
      routes: routes,
      errorHandler: e => /*#__PURE__*/jsx(RouterError, {
        error: e
      }),
  ...
  if (mode === 'memory') {
    return /*#__PURE__*/jsxs(MemoryRouter, {
      initialEntries: ['/'],
      routes: routes,
      errorHandler: e => /*#__PURE__*/jsx(RouterError, {
        error: e
...
reactDom.exports.render( /*#__PURE__*/jsx(App, {}), document.getElementById('root'));

export { Link as L, View as V, jsx as a, commit as b, createHref as c, resolve as d, reactDom as e, useData as f, jsxs as j, react as r, toLocation as t, useRouter as u };
